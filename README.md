...
- **Authentication**: JWT với 3 vai trò

### 3 Vai trò người dùng

| Vai trò | Mô tả | Quyền hạn |
|---------|--------|-----------|
| **Admin** | Quản trị viên | Quản lý Khoa, Ngành, Lớp, Môn học, Duyệt tuyển sinh, Thông báo |
| **Sinh viên** | Sinh viên đã trúng tuyển | Xem điểm, GPA, xếp loại tốt nghiệp, thông báo |
| **Thí sinh** | Thí sinh đăng ký xét tuyển | Đăng ký, nộp hồ sơ, xem trạng thái |
...
│  - Dashboard theo role (Admin/SV/Thí sinh)   │
...
| **Lop** | Quản lý Lớp | Lop |
| **TuyenSinh** | Quy trình tuyển sinh | TK_XETTUYEN, HSO_XETTUYEN, PT_XETTUYEN |
...
- [Lop.md](docs/Lop.md)
- [TuyenSinh.md](docs/TuyenSinh.md)
...
| Bảng | Trường | Quy tắc |
|------|--------|---------|
| TK_XETTUYEN | Email | Unique, đuôi `@gmail.com` |
| TK_XETTUYEN | MatKhau | Min 6 ký tự |
| HSO_XETTUYEN | CCCD | Unique, đúng 10 số |
| HSO_XETTUYEN | SDT | Unique, đúng 10 số |
| PT_XETTUYEN | Diem | 0-30 |
| PT_XETTUYEN | TrangThai | Chờ duyệt / Đậu / Rớt |
| KQ_HocTap | Diem | 0-10 |
...
```
1. Thí sinh đăng ký → TK_XETTUYEN
2. Thí sinh nộp hồ sơ → HSO_XETTUYEN
3. Thí sinh nộp đơn → PT_XETTUYEN (Trạng thái: Chờ duyệt)
4. Admin duyệt → Trạng thái: Đậu → Auto tạo SinhVien
                  Trạng thái: Rớt
```
...
| POST | `/api/auth/register-candidate` | Đăng ký thí sinh | No |
