...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <p class="mt-4 text-center text-gray-600">
        Chưa có tài khoản?
        <a href="<?php echo e(route('candidate.register')); ?>" class="text-blue-600 hover:underline">Đăng ký ngay</a>
    </p>
</div>
<?php /**PATH C:\Users\haqua\Documents\GitHub\QLSVSDH\resources\views/livewire/auth/candidate-login.blade.php ENDPATH**/ ?>